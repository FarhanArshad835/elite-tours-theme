...
<section class="et-page-hero">
    ...
    <div class="et-container">
        <div class="et-page-hero__content et-reveal">
            <h1 class="et-page-hero__title">Authentic Irish Experiences,<br>Curated for You.</h1>
            <p class="et-page-hero__sub">Every experience we offer is privately curated, personally hosted, and built around your interests.</p>
        </div>
    </div>
</section>
...
<section class="et-section et-section--white">
    <div class="et-container">
        <div class="et-section__header et-section__header--center et-reveal">
            <h2 class="et-section__title">Browse All Experiences</h2>
            <p class="et-section__subtitle"><?php echo count( $all_experiences ); ?> experiences across Ireland</p>
        </div>
